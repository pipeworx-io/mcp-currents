...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/currents_latest_news \
  -H 'Content-Type: application/json' \
  -d '{"language":"en","category":"technology","limit":15}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/currents_latest_news`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
